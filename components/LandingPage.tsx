      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
        ...
        >
          <motion.div 
            ...
            className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white border border-slate-300/60 mb-10 shadow-sm"
          >
            <span className="flex h-2.5 w-2.5 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500"></span>
            </span>
            <span className="text-sm font-bold text-slate-600 tracking-widest uppercase">El estándar en gestión dental</span>
          </motion.div>
        ...
        >
          ...
          <div className="relative rounded-[2.5rem] bg-white p-4 backdrop-blur-3xl border border-slate-300/60 shadow-2xl shadow-slate-200/50 overflow-hidden">
            {/* Minimalist Browser Bar */}
            <div className="flex items-center gap-2 px-4 pb-4 pt-2 border-b border-slate-300 mb-4">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-slate-50 aspect-[16/9] md:aspect-[21/9]">
                ...
                <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 w-64 animate-float">
                   <div className="flex items-center gap-3 mb-3">
                     <div className="w-11 h-11 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600"><CheckCircle2 size={20}/></div>
                     <div>
                       <p className="text-sm font-bold text-slate-900">Cita Confirmada</p>
                       <p className="text-sm text-slate-500">Hoy, 10:30 AM</p>
                     </div>
                   </div>
                ...
                <div className="absolute bottom-8 right-8 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-xl border border-white/50 animate-float" style={{ animationDelay: '2s' }}>
                   <p className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-1">Ingresos Semanales</p>
        ...
        <div className="mb-20 text-center">
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-slate-900 mb-6">Poderoso. <br className="hidden md:block"/><span className="text-slate-500">Extraordinariamente simple.</span></h2>
        </div>
        ...
        >
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: 'spring' } } }} 
            className="md:col-span-2 relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-300/60 p-10 hover:shadow-2xl hover:shadow-blue-500/5 hover:-translate-y-1 transition-all group"
          >
          ...
          {/* Card 2: Odontograma */}
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: 'spring' } } }} 
            className="relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-300/60 p-10 hover:shadow-2xl hover:shadow-emerald-500/5 hover:-translate-y-1 transition-all group"
          >
          ...
          {/* Card 3: Finanzas */}
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: 'spring' } } }} 
            className="relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-300/60 p-10 hover:shadow-2xl hover:shadow-amber-500/5 hover:-translate-y-1 transition-all group"
          >
          ...
          {/* Card 4: Expediente */}
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { type: 'spring' } } }} 
            className="md:col-span-2 relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-300/60 p-10 hover:shadow-2xl hover:shadow-indigo-500/5 hover:-translate-y-1 transition-all group flex flex-col md:flex-row gap-10 items-center"
          >
        ...
        >
          <div className="bg-white border border-slate-300 rounded-[3rem] p-12 text-center relative overflow-hidden hover:border-blue-200 hover:shadow-[0_20px_60px_rgba(59,130,246,0.1)] transition-all">
